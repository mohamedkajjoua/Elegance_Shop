...
class CartService
{
    ...
    {
        // ✅ تم التعديل: تحميل الصور مباشرة
        return $this->getUserCart($userId)
            ->load('cartItems.productVariant.product.images');
    }
    ...
    public function update(int $userId, int $itemId, int $quantity): Cart
    {
        ...
        // ✅ تم التعديل: الصور موجودة هنا (هذا يحل مشكلة اختفائها عند الضغط على +)
        return $cart->load('cartItems.productVariant.product.images');
    }
    ...
    public function remove(int $userId, int $itemId): Cart
    {
        ...
        // ✅ تم التعديل: تحميل الصور لباقي العناصر بعد الحذف
        return $cart->load('cartItems.productVariant.product.images');
    }
}
