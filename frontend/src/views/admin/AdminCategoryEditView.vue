        ...
        <div class="max-w-2xl">
          <div class="bg-white rounded-lg md:rounded-xl p-4 md:p-6 shadow-sm">
            ...
            <div v-if="categoryStore.isLoading" class="text-center py-4">
              <i class="fa-solid fa-spinner fa-spin text-orange-500"></i> Loading...
            </div>
            ...
            <form v-else @submit.prevent="handleSubmit" class="space-y-4">
              ...
              >
                ...
                >
                  <i v-if="categoryStore.isLoading" class="fa-solid fa-spinner fa-spin mr-2"></i>
                  <i v-else class="fa-solid fa-save mr-2"></i> Update Category
                </button>
              </div>
            </form>
          </div>
