          ...
          <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex flex-wrap gap-2">
              ...
              <div class="relative group">
                ...
                <div
                  class="absolute right-0 mt-1 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-10 hidden group-hover:block"
                >
                  <button
                    @click="updateOrderStatus('pending')"
                    class="block w-full text-left px-4 py-2 hover:bg-gray-50 text-sm"
                  >
                    Pending
                  </button>
                  <button
              ...
              <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                ...
                >
                  <div
                    ...
                    :key="item.id"
                    class="p-4 md:p-6 flex gap-4"
                  >
                    <div
                      class="w-16 h-16 md:w-20 md:h-20 rounded-lg bg-gray-100 flex items-center justify-center flex-shrink-0"
                    >
                    ...
                    <div class="flex-1 min-w-0">
                      ...
                      <div class="flex flex-wrap gap-2 mt-1 text-sm text-slate-500">
                        <span v-if="item.product_variant?.color"
                          >Color: {{ item.product_variant.color }}</span
                        >
                        <span v-if="item.product_variant?.size"
                          >• Size: {{ item.product_variant.size }}</span
                        >
                      </div>
                    </div>
              ...
              <div class="bg-white rounded-xl p-4 md:p-6 shadow-sm">
                ...
                <div class="space-y-3">
                  ...
                  <div class="flex justify-between">
                    ...
                    <span class="text-slate-800 font-medium">
                      {{ formatCurrency(calculateShipping()) }}</span
                    >
                  </div>
                  <div
                    class="flex justify-between pt-3 border-t border-gray-200 text-lg font-semibold"
                  >
                ...
                <div class="space-y-4">
                  ...
                  <div class="flex gap-3">
                    ...
                    <div class="pb-4">
                      ...
                      <p class="text-sm text-slate-500">
                        {{ order.status }} on {{ formatDate(order.updated_at) }}
                      </p>
                    </div>
                  </div>
                  <div class="flex gap-3">
