  ...
  <div class="min-h-screen bg-gray-100 flex">
    ...
    <aside :class="[
      ...
      <nav class="flex-1 overflow-y-auto py-4">
        ...
        <!-- Products - Active with Submenu Toggle -->
        <div class="relative">
          ...
          <div v-show="productsOpen" class="bg-slate-900/50 py-2">
            ...
            <router-link to="/admin/products/create" class="block px-12 py-2 text-sm text-slate-300 hover:text-orange-500 transition-colors">Create Product</router-link>
          </div>
        </div>
    ...
    <div class="flex-1 lg:ml-64">
      ...
      <header class="bg-white h-16 flex items-center justify-between px-4 md:px-6 sticky top-0 z-10 shadow-sm">
        ...
        <h1 class="text-base md:text-lg font-bold text-slate-800">PRODUCT LIST</h1>
