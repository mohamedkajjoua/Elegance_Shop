...
<template>
  <footer class="footer-wrapper">
    <!-- Main Footer -->
    <div class="bg-gradient-to-b from-gray-900 to-gray-950 text-white">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div class="lg:col-span-4">
            <div class="flex items-center gap-3 mb-6">
              <div
                class="w-12 h-12 bg-gradient-to-br from-primary to-purple-600 rounded-2xl flex items-center justify-center shadow-lg shadow-primary/30"
              >
                <i class="fa-solid fa-shapes text-white text-xl"></i>
              </div>
              <span class="text-2xl font-black text-white">
                {{ settingStore.settings.site_name }}</span
              >
            </div>
            <p class="text-gray-400 text-sm leading-relaxed mb-8 max-w-sm">
              Your ultimate destination for trendy and quality fashion. We bring the latest styles
              right to your doorstep with premium quality and unbeatable prices.
            </p>
            ...
            <div class="flex">
              <div class="flex gap-3">
                <a
                  ...
                  aria-label="facebook"
                  class="w-11 h-11 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 transition-all duration-300 hover:bg-primary hover:border-primary hover:text-white hover:scale-110 hover:shadow-lg hover:shadow-primary/30"
                >
          ...
          <div class="lg:col-span-2">
            ...
            <ul class="space-y-4">
              <li v-for="link in footerLinks.shop" :key="link.name">
                <router-link
                  :to="link.to"
                  class="text-gray-400 text-sm hover:text-white hover:pl-2 transition-all duration-300 flex items-center gap-2 group"
                >
                  <i
                    class="fa-solid fa-chevron-right text-[8px] opacity-0 group-hover:opacity-100 transition-opacity text-primary"
                  ></i>
                  {{ link.name }}
                </router-link>
              </li>
          ...
          <div class="lg:col-span-2">
            ...
            <ul class="space-y-4">
              <li class="flex items-start gap-3">
                ...
                <span class="text-gray-400 text-sm"> {{ settingStore.settings.visit_us }}</span>
              </li>
              <li class="flex items-center gap-3">
                ...
                <span class="text-gray-400 text-sm">+212 {{ settingStore.settings.call_us }}</span>
              </li>
              <li class="flex items-center gap-3">
                <div
                  class="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center flex-shrink-0"
                ...
                <span class="text-gray-400 text-sm"> {{ settingStore.settings.email_us }}</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="mt-16 pt-10 border-t border-white/10">
          <div class="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div class="text-center lg:text-left">
              <h4 class="font-bold text-white text-xl mb-2">Download Our App</h4>
              <p class="text-gray-400 text-sm">Get exclusive app-only deals and shop on the go!</p>
            </div>
            <div class="flex flex-wrap justify-center gap-4">
              <a
                href="#"
                class="flex items-center gap-3 px-5 py-3 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-colors group"
              >
              ...
              >
                ...
                <div class="text-left">
                  <div class="text-[10px] text-gray-400 uppercase tracking-wide">Get it on</div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p class="text-gray-500 text-sm text-center md:text-left">
            © {{ currentYear }} {{ settingStore.settings.site_name }}. All rights reserved. Made
            with
            <i class="fa-solid fa-heart text-red-500 text-xs mx-1"></i>
            for fashion lovers.
          </p>
          ...
          <div class="flex items-center gap-4">
            ...
            <div class="flex gap-2">
              <i
                ...
                :key="method"
                :class="method"
                class="text-2xl text-gray-500 hover:text-white transition-colors cursor-pointer"
              ></i>
            </div>
          </div>
...
.footer-wrapper::before {
  ...
  right: 0;
  height: 1px;
  background: linear-gradient(90deg, transparent, rgba(95, 46, 234, 0.5), transparent);
}
</style>
