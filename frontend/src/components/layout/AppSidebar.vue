...
import { useProductShopStore } from "@/stores/user/ProductShop"; // ✅ استيراد الستور
import { useRoute } from "vue-router"; // ✅ لقراءة الرابط
...
function syncFiltersWithURL() {
  ...
  if (q.brand_id) selectedTypes.value = [Number(q.brand_id)]; // Assuming single selection logic or adjust for array
